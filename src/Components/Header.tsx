...
const Header = () => {
    ...
    return (
        <Nav animate={navAnimation} initial={{ backgroundImage: "linear-gradient(180deg,rgba(0,0,0,.7) 10%,transparent)" }}>
            <Col>
                <Logo variants={logoVariants} whileHover="active" initial="normal" xmlns="http://www.w3.org/2000/svg" height="276.742" width="1024" viewBox="-153.6 -69.1855 1331.2 415.113">
            ...
            <Col>
                <Search>
                    ...
                    <Input animate={{ scaleX: searchOpen ? 1 : 0 }} transition={{ type: 'linear' }} placeholder='제목,사람,장르' />
                </Search>
            </Col>
        </Nav>
    )
